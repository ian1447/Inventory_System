...
<nav class="navbar navbar-expand-lg fixed-top" style="background-color: #041C32">
      <div class="container-fluid">
        ...
        <a
          class="navbar-brand text-white p-2 me-auto ms-lg-0 ms-3 text-uppercase fw-bold"
          href="#"
        ...
        <div class="collapse navbar-collapse" id="topNavBar">
          ...
          <span class="fw-bold text-white"><?php echo $_SESSION['username']; ?></span>
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end" style="background-color: #ECB365">
                <li class="dropdown-header">
                  <span class="me-2"><i class="bi bi-person-circle"></i></span>
                  Welcome <?php echo $_SESSION['username']; ?>!
                </li>
                <li>
                  <a class="dropdown-item" href="./update_acc.php">
